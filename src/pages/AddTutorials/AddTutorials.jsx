...
const AddTutorials = () => {
  ...
  return (
    <div className="my-10 px-1 max-w-7xl mx-auto text-xs md:text-sm flex justify-center gap-10 items-center">
      <div className="text-center lg:text-left w-[40%]">
        <Lottie animationData={formAnime} loop={true} />
      </div>
      <div className="p-6 w-[60%] border border-gray-100 rounded-lg shadow-md mt-10">
