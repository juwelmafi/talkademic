          ...
          <div className="join join-vertical bg-base-100 w-full">
            <div className="collapse collapse-arrow join-item border-base-300 border">
              ...
              <div className="collapse-content text-sm">
                Simply browse tutors by category or subject, view their
                profiles, and click “Book Now” to schedule a session at your
                convenience.
              </div>
            </div>
            <div className="collapse collapse-arrow join-item border-base-300 border">
              ...
              <div className="collapse-content text-sm">
                Some tutors offer free trial sessions. Check their profiles for
                details or use the filter to find trial-available tutors.
              </div>
            </div>
            <div className="collapse collapse-arrow join-item border-base-300 border">
              <input type="radio" name="my-accordion-4" />
              ...
              <div className="collapse-content text-sm">
                ...
                session time through your dashboard without any extra charges.
              </div>
            </div>
            <div className="collapse collapse-arrow join-item border-base-300 border">
              <input type="radio" name="my-accordion-4" />
              ...
              <div className="collapse-content text-sm">
                Yes, all tutors go through a strict verification process,
                including educational background and identity checks, before
                being listed.
              </div>
            </div>
            <div className="collapse collapse-arrow join-item border-base-300 border">
              ...
              <div className="collapse-content text-sm">
                Talkademic offers a wide range of subjects, from academic topics
                to spoken languages like English, Bangla, Arabic, and more.
              </div>
            </div>
          </div>
        </div>
